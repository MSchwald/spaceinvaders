...
class Statusbar:
    ...
    def position_stats(self, factor = 1):        
            ...
            self.level_x = 0
            self.level_y = self.y + 1/16*self.h

            self.lives_icon_x = self.level_x+21/8*self.h
    ...
    def blit(self, screen, ship, level_number):
            ...
            screen.blit(self.health_bar.surface,(self.x+self.health_x,self.health_y), area=(0,0,ship.energy/ship.max_energy*self.health_bar.w,self.health_bar.h))
            ...
            screen.blit(self.shield_bar.surface,(self.x+self.shield_timer_x,self.shield_timer_y), area=(0,0,ship.shield_timer/(1000*settings.max_shield_duration)*self.shield_bar.w,self.shield_bar.h))
