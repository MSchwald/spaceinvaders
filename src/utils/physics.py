...
class Vector:
    ...
    def change_direction(self, other: Vector) -> Vector:
        ...
        self = self.norm * other.normalize
    ...
    def randomize_direction(self, phi_min: float = 0,
        ...
        self = self.norm * Vector(cos(phi), sin(phi))
    ...
    def turn_by_angle(self, phi: float) -> Vector:
...
def ball_collision_data(ball1: Ball, ball2: Ball, m1: float, m2: float) -> tuple[float | None, Vector, Vector]:
    ...
    n2dv, n2dp, dpdv,  = dv.norm2, dp.norm2, dp * dv
    ...
    if (n2dv > 1e-8     # avoids division problems
        ...
        new_v1, new_v2 = elastic_collision(ball1.vel, ball2.vel, m1, m2, dp.normalize)
